...
import com.android.thongph.androidutils.R;
...
/**
 * Android Utils Created by thongph on 3/2/17.
 */
...
public class NotificationUtils {
    ...
    public void showNotificationMessage(String title, String message) {
        showNotificationMessage(title, message, null, null);
    }

    public void showNotificationMessage(String title, String message, PendingIntent pendingIntent) {
        showNotificationMessage(title, message, pendingIntent, null);
    }
